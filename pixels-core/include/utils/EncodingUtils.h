...
class EncodingUtils {
  public:
    ...
    void readRemainingLongs(const std::shared_ptr<ByteBuffer> &input,
    ...
    void writeLongBE(std::shared_ptr<ByteBuffer> output, long *input,
                     int offset, int numHops, int numBytes);
    void writeLongBE2(std::shared_ptr<ByteBuffer> output, long val,
                      int wbOffset);
    void writeLongBE3(std::shared_ptr<ByteBuffer> output, long val,
                      int wbOffset);
    void writeLongBE4(std::shared_ptr<ByteBuffer> output, long val,
                      int wbOffset);
    void writeLongBE5(std::shared_ptr<ByteBuffer> output, long val,
                      int wbOffset);
    void writeLongBE6(std::shared_ptr<ByteBuffer> output, long val,
                      int wbOffset);
    void writeLongBE7(std::shared_ptr<ByteBuffer> output, long val,
                      int wbOffset);
    void writeLongBE8(std::shared_ptr<ByteBuffer> output, long val,
                      int wbOffset);
    void writeRemainingLongs(std::shared_ptr<ByteBuffer> output, int offset,
                             long *input, int remainder, int numBytes);
    void writeShortLE(std::shared_ptr<ByteBuffer> output, int16_t value);
    void writeShortBE(std::shared_ptr<ByteBuffer> output, int16_t value);
    // -----------------------------------------------------------
  private:
    enum FixedBitSizes {
        ONE,
