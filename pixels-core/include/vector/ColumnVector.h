...
class ColumnVector {
  public:
    /**
     * length is the capacity, i.e., maximum number of values, of this column
     * vector <b>DO NOT</b> modify it or used it as the number of values
     * in-used.
     */
    uint64_t length;
    uint64_t writeIndex;
     ...
     * be re-used later and nulls added.
     */
    uint8_t *isNull;
